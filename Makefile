...
## Create a conda environment named 'dkrz_cera', install packages, and activate it
conda-env:
	@echo "Create conda environment 'dkrz_cera"
	conda create --name dkrz_cera python=3.10 --no-default-packages 
	@echo "Activate conda environment 'dkrz_cera'"
	conda activate dkrz_cera
