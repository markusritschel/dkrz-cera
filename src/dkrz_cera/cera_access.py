...
class Cera:
    ...
    def __get_credentials(self, netrc_file=".netrc"):
        # Resolution order: env vars → .env file (cwd then home) → ~/.netrc

        # 1. Environment variables
        user = os.environ.get("CERA_USER")
        password = os.environ.get("CERA_PASSWORD") or os.environ.get("CERA_PASS")
        ...
        for search_dir in [os.getcwd(), os.path.expanduser("~")]:
            dotenv_path = os.path.join(search_dir, ".env")
        ...
        try:
            ...
            print(
                "Cannot find user credentials. Make sure you have a .netrc file in your home directory "
